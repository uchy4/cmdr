...
class CreateDir
{
    public static void Main()
    {
        ...
        try
        {
            ...
            if (principal.IsInRole(WindowsBuiltInRole.Administrator))
            {
                ...
                if (Directory.Exists(path))
                {
                    ...
                    MessageBox.Show("The directory was deleted successfully at " +  Directory.GetCreationTime(path));
                }
                ...
                MessageBox.Show("Cmdr uninstallation complete");
            }
            else
            {
        ...
        {
            MessageBox.Show("INCOMPLETE: CLose all programs that use 'Cmds' folder");
            Console.WriteLine("The process failed: {0}", e.ToString());
        }
        catch (Exception e)
        {
